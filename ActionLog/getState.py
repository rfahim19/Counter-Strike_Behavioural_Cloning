...
# import startServer
from startServer import CSGOGameStateServer, CSGOGameStateRequestHandler


# CSserver = CSGOGameStateServer(('localhost', 3000), CSGOGameStateRequestHandler)
CSserver = CSGOGameStateServer(('localhost', 3000))
...
def screen_record():
    ...
    while True:
        file_name = 'D:\Work\\train-demo\\training_data\\training_data-{}.npy'.format(starting_value)
    ...
    while(True):
        if not paused:
            ...
            # training_data.append([screen, str(output), ('get_reward')()])
